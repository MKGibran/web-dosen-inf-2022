          ...
          <ul class="navbar-nav d-flex justify-content-end">
            <li class="nav-item d-flex align-items-center mx-2">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0" style="cursor: default;">
                ...
                <span class="d-sm-inline d-none"><?= session()->get('logged_in'); ?></span>
              </a>
            </li>
              ...
              <div class="row">
                <div class="col-lg-6 col-7">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1">30 Dosen</span> Program Studi Manajemen Informatika
                  </p>
                </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="<?= base_url('/assets/img/small-logos/logo-atlassian.svg') ?>" class="avatar avatar-sm me-3"
                              alt="atlassian">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="<?= base_url('/assets/img/small-logos/logo-slack.svg') ?>"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="<?= base_url('/assets/img/small-logos/logo-invision.svg') ?>" class="avatar avatar-sm me-3"
                              alt="invision">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
