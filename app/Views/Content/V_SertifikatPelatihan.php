    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Sertifikat Pelatihan</li>
          </ol>
        <h6 class="font-weight-bolder mb-0">Sertifikat Pelatihan</h6>
      </nav>
          ...
          <div class="card-body px-0 pb-2">
              ...
              <ul class="list-inline">
                ...
                <li class="list-inline-item float-end">
                  <button class="btn bg-gradient-primary d-flex float-end rounded-pill text-sm text-lowercase"
                    data-bs-toggle="modal" data-bs-target="#addPelatihan">
                    tambah <i class="bi bi-plus-lg"></i>
                  </button>
                  <!-- Modal Add Data Pelatihan -->
                  <div class="modal fade" id="addPelatihan" tabindex="-1" aria-labelledby="addPelatihan"
                    aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="<?= base_url('C_SertifikatPelatihan/AddData') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="table-responsive container-fluid mt-3">
              <table class="table align-items-center mb-0 data table-borderless border-white">
                ...
                <tbody>
                  <?php $i = 1; ?>
                  <?php foreach ($pelatihans as $pelatihan):?>
                  <tr>
                    <td>
                      <?= $i; ?>
                    </td>
                    ...
                    <td>
                      <a class="btn bg-gradient-danger rounded-pill text-sm my-auto text-lowercase"
                        href="<?= base_url('detail-dosen/sertifikat-pelatihan/delete/'.$pelatihan['id']) ?>">
