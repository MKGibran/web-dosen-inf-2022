    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Sertifikat Workshop</li>
          </ol>
        <h6 class="font-weight-bolder mb-0">Sertifikat Workshop</h6>
      </nav>
              ...
              <ul class="list-inline">
                ...
                <li class="list-inline-item float-end">
                  <button class="btn bg-gradient-primary d-flex float-end rounded-pill text-sm text-lowercase"
                    data-bs-toggle="modal" data-bs-target="#addWorkshop">
                    tambah <i class="bi bi-plus-lg"></i>
                  </button>
                  <!-- Modal Add Data Workshop -->
                  <div class="modal fade" id="addWorkshop" tabindex="-1" aria-labelledby="addWorkshop"
                    aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Tambah Sertifikat Workshop</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                          <form action="<?= base_url('C_SertifikatWorkshop/AddData') ?>" method="POST" enctype="multipart/form-data">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn bg-gradient-danger rounded-pill text-sm my-auto text-lowercase"
                        href="<?= base_url('detail-dosen/sertifikat-workshop/delete/'.$workshop['id']) ?>">
