...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0 px-5" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
        target="_blank">
        <img src="<?= base_url('/assets/img/logo_sidebar.png') ?>" class="navbar-brand-img h-100" alt="main_logo">
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?= ($page == "home" || $page == "index.php" ? "active" : "") ?>" 
          href="<?= base_url('/') ?>">
            <div
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($page == "rekapitulasi" ? "active" : "") ?>" href="<?= base_url('rekapitulasi/') ?>">
        ...
        <li class="nav-item">
          <a class="nav-link <?= ($page == "akun" ? "active" : "") ?>" href="<?= base_url('akun/') ?>">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
